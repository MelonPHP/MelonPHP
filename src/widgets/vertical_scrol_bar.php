...
class VerticalScrollBar extends Widget {
    ...
    private function getContainerStyle() {
        return new StyleStrategy(
            name: CssTags::class("__vertical_scroll_bar"),
            styles: [ 
                new StyleValue(CssTags::Width, Metrica::pr(100)),
                new StyleValue(CssTags::Height, Metrica::pr(100)),
                new StyleValue(CssTags::OverflowX, CssTags::Hidden),
                new StyleValue(CssTags::OverflowY, CssTags::Auto),
            ],
        );
    }
